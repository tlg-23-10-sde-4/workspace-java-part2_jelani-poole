...
public class Catalog {
     ...
     * entry _for_each_ brand supplied, with a corresponding collection of matching
     * Televisions for that brand.
     *
    ...
    public static Map<String, Collection<Television>> findByBrands(String... brands) {
        ...
        // TODO - hint: brands is a Sting[] array in here, and you can for-each over it
