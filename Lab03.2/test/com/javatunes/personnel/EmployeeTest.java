...
public class EmployeeTest {
    ...
    public void setUp() {
        ...
        emp1 = new Employee("Mary Lou", Date.valueOf("1999-09-09")) {
            public double pay() { return 0; }
            public double payTaxes() { return 0; }
        };

        emp2 = new Employee("Mary Lou", Date.valueOf("1999-09-09")) {
            public double pay() { return 0; }
            public double payTaxes() { return 0; }
        };
    }
...
//    };
    ...
    @Test
    public void equals_shouldReturnTrue_sameName_differentHireDate() {
